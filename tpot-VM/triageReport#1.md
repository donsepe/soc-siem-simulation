...
*1. 2026-07–16 09:01:51.364 UTC+8 : A connection was attempted by the attacker with IP Address 129.232.16.47 via SSH.
*2. 2026-07–16 09:01:53.180 UTC+8 : The node executed a login attempt in the same session with username: ‘root’ & password: ‘doudou33’.
*3. 2026-07–16 09:01:54.595 UTC+8: Session was terminated after the failed log in attempt by the attacker.
...
* 4. Block Attacker IP - Recommend to block IP address 129.232.16.47.
